...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, EN_MICS6814_Pin|EN_ESP8266_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PA0 PA7 PA11 PA12 
                           PA13 PA14 PA15 */
  GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_7|GPIO_PIN_11|GPIO_PIN_12 
                          |GPIO_PIN_13|GPIO_PIN_14|GPIO_PIN_15;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : EN_MICS6814_Pin EN_ESP8266_Pin */
  GPIO_InitStruct.Pin = EN_MICS6814_Pin|EN_ESP8266_Pin;
